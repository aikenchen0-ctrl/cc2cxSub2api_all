(() => {
  function mount() {
    if (document.querySelector("[data-sub2api-balance-widget]")) return;
    ...
    root.innerHTML = `<style>
      :host{position:fixed;top:12px;right:16px;z-index:2147483000;font:12px/1.2 system-ui,-apple-system,"Segoe UI",sans-serif;color:#334155}
      .pill{display:inline-flex;align-items:center;gap:6px;padding:6px 10px;border:1px solid #cbd5e1;border-radius:999px;background:#ffffffed;color:inherit;font:inherit;white-space:nowrap;cursor:pointer;box-shadow:0 4px 18px #0002}
