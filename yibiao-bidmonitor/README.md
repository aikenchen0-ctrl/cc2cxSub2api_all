...
- 招标监控：保留 BidMonitor-AI 的多站点采集、关键词匹配、AI 过滤和通知能力，通过独立 Python 服务按用户隔离运行。

- Sub2API 单点登录：支持短时效票据、管理员身份映射和本地 JWT 会话。
...
完整说明见 [功能清单](docs/FEATURES.md)、[架构文档](docs/ARCHITECTURE.md)、[招标监控与 Sub2API 集成说明](docs/yibiao-bidmonitor-sub2api-integration.md) 与 [功能设计说明](docs/superpowers/specs/2026-08-19-web-module-branding-theme-docs-design.md)。
