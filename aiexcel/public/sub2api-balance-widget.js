(() => {
  ...
  function mount(host) {
    ...
    root.innerHTML = `<style>
      ...
      .pill{display:inline-flex;align-items:center;gap:5px;padding:5px 8px;border:1px solid #9ca3af55;border-radius:999px;background:transparent;color:inherit;font:inherit;white-space:nowrap;cursor:pointer}
      .amount{font-variant-numeric:tabular-nums;font-weight:650}.amount.low{color:#dc2626}
      ...
      .dialog h2{margin:0 0 8px;font-size:18px}.dialog p{margin:0 0 18px;color:#4b5563;line-height:1.6}.dialog .actions{display:flex;justify-content:flex-end;gap:8px}
