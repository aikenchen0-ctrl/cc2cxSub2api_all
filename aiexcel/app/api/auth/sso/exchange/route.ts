...
import { createSession, readHandoff, HANDOFF_COOKIE, SESSION_COOKIE, SESSION_TTL_SECONDS } from "../../../../auth-sso";
...
export async function POST(request: NextRequest) {
  ...
  response.cookies.set(SESSION_COOKIE, createSession(user), { httpOnly: true, secure: request.nextUrl.protocol === "https:", sameSite: "lax", maxAge: SESSION_TTL_SECONDS, path: "/" });
  return response;
}
