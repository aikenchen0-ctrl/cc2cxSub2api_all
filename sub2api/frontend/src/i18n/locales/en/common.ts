export default {
  ...
  nav: {
    ...
    quickAppsKeyUnavailable: 'Unable to load the Super API Key. Sign in again and retry.',
    quickAppsSsoUnavailable: 'Unable to open the quick app. Allow pop-ups and check your sign-in status. If it still fails, ask your administrator to check the SSO configuration.',
    quickAppsSsoNeedLogin: 'Sign in before opening this quick app.',
    quickAppsSsoPopupBlocked: 'The browser blocked the pop-up. Allow pop-ups for this site and try again.',
    quickAppsSsoNotConfigured: 'Single sign-on is not configured. Set SUB2API_SSO_SECRET (at least 32 characters) and the target app SSO_CALLBACK_URL, then restart the services.',
    infiniteCanvas: 'AI Image & Video',
    smartShortDrama: 'AI Director Station',
    superCanvas: 'Super Image Edit',
    aiProductImage: 'AI Product Images',
    eternalPpt: 'PPT Generator',
    aiCut: 'AI Editor',
    screen2code: 'AI Website Recreator',
    aiExcel: 'AI Spreadsheet',
    artQr: 'Art QR',
    yibiao: 'AI Bid Finder & Tendering',
    ai3d: 'Image to 3D',
    aihuoke: 'AI Lead Hunter',
    agentApi: 'Agent API',
    modelAudit: 'Upstream Audit',
    openAgentStation: 'Open agent station',
    dashboard: 'Dashboard',
    ...
    agentProvisioning: 'Agent Stations',
  ...
  agentProvisioning: {
    title: 'Agent Station Management',
    description: 'Manage AgentAPI station control-plane records and review their reported deployment state.',
    streamStatus: 'Live update connection status',
    live: 'Live updates',
    reconnecting: 'Reconnecting',
    controlPlaneNoticeTitle: 'The deployment worker must be installed on a controlled edge node',
    controlPlaneNotice: 'Worker source is available for deployment, DNS/TLS/readyz checks, and activation; creating a record does not start it. The worker uses a shared provisioning-only credential restricted by the main-site API allowlist, but its Docker/Nginx host access must still be tightly restricted. AgentAPI runtime instances still use the global main-site admin key; per-Agent runtime credentials remain unresolved. Managed instances subscribe to authoritative state using the same agt_ ID; suspend/revoke block requests and unknown/stale state fails closed. Without an installed worker, operations must deploy and confirm readyz manually.',
    create: 'Create station',
    slug: 'Slug',
    domainSuffix: 'The platform domain uses the .cc2.cx suffix.',
    displayName: 'Display name',
    ownerMainUserId: 'Main-site admin user ID',
    planId: 'Plan ID',
    planIdHint: 'Format is checked; the plan itself is not looked up yet.',
    brandName: 'Brand name',
    logoUrl: 'Logo URL (HTTPS)',
    submitCreate: 'Save control record',
    search: 'Search',
    searchPlaceholder: 'Slug, domain, name, or owner ID',
    status: 'Status',
    allStatuses: 'All statuses',
    currentStep: 'Reported step',
    domainStatus: 'Domain status',
    recentError: 'Recent error',
    updatedAt: 'Updated',
    activate: 'Confirm readiness & activate',
    retry: 'Retry deployment',
    suspend: 'Suspend',
    resume: 'Resume',
    revoke: 'Revoke',
    empty: 'No agent stations found.',
    loadFailed: 'Could not load agent stations.',
    createFailed: 'Could not create the control record.',
    actionFailed: 'Could not update the control record.',
    confirmRevoke: 'Type {id} to confirm revocation.',
    confirmReadiness: 'I verified that AgentAPI /readyz succeeds at {domain}, and its server credentials, owner, and persistent volume are configured.',
    confirmationMismatch: 'The confirmation text must exactly match the agent ID.',
    readinessConfirmationRequired: 'Confirm the external readiness check before activating this station.',
    activateTitle: 'Confirm this station is ready and activate it?',
    activateMessage: 'Activation opens registration and business requests for managed instances using this Agent ID. Verify deployment and domain configuration first.',
    retryTitle: 'Retry station deployment?',
    retryMessage: 'This clears the retryable failure and runs deployment again. Fix the issue described by the recent error first.',
    suspendTitle: 'Request station suspension?',
    suspendMessage: 'This sets {domain} to suspended in the main control plane; managed AgentAPI instances will reject new business requests.',
    resumeTitle: 'Request station resume?',
    resumeMessage: 'This restores {domain} to the active desired state; managed instances resume business requests after confirming it.',
    revokeTitle: 'Revoke station record?',
    revokeMessage: 'This permanently marks {domain} revoked. Managed instances will reject business requests. This action cannot be undone.',
    statuses: {
      pending: 'Pending',
