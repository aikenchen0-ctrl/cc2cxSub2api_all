export default {
  ...
  nav: {
    ...
    quickAppsSsoNotConfigured: 'Single sign-on is not configured. Set SUB2API_SSO_SECRET (at least 32 characters) and the JU_SSO_CALLBACK_URL / LIVART_SSO_CALLBACK_URL, then restart the services.',
    infiniteCanvas: 'Infinite Canvas',
    smartShortDrama: 'Smart Theater',
    superCanvas: 'Super Image Edit',
    eternalPpt: 'Eternal PPT',
