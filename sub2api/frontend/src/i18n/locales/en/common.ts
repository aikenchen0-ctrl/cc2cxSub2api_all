export default {
  ...
  nav: {
    ...
    quickAppsSsoUnavailable: 'Unable to open Smart Theater. Allow pop-ups and check your sign-in status. If it still fails, ask your administrator to check the SSO configuration.',
