...
const adminNavItems = computed((): NavItem[] => {
  ...
  if (authStore.isSimpleMode) {
    ...
    filtered.push({ path: '/admin/satellite-billing', label: t('nav.satelliteBilling'), icon: PriceTagIcon })
  ...
  visible.push({ path: '/admin/satellite-billing', label: t('nav.satelliteBilling'), icon: PriceTagIcon })
