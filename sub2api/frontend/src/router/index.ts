...
const routes: RouteRecordRaw[] = [
  ...
  },
  {
    ...
    meta: { requiresAuth: false, title: 'Downloads', titleKey: 'downloads.title' }
  },
  ...
  {
    path: '/admin/agent-provisioning',
    name: 'AdminAgentProvisioning',
    component: () => import('@/views/admin/AgentProvisioningView.vue'),
    meta: {
      requiresAuth: true,
      requiresAdmin: true,
      title: 'Agent Provisioning',
      titleKey: 'agentProvisioning.title',
      descriptionKey: 'agentProvisioning.description'
    }
  },
  {
    path: '/admin/proxies',
...
const BACKEND_MODE_ALLOWED_PATHS = ['/login', '/key-usage', '/setup', '/payment/result', '/payment/airwallex', '/legal', '/downloads']
