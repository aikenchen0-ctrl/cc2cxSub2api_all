...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	agentProvisioningRepository := repository.ProvideAgentProvisioningRepository(db, configConfig)
	agentProvisioningService := service.NewAgentProvisioningService(agentProvisioningRepository)
	...
	agentRuntimeHandler := handler.NewAgentRuntimeHandler(agentProvisioningService, userService, usageService)
	agentProvisioningHandler := handler.NewAgentProvisioningHandler(agentProvisioningService)
	...
	authHandler := handler.ProvideAuthHandler(configConfig, authService, userService, settingService, promoService, redeemService, totpService, userAttributeService, apiKeyService)
	...
	handlers := handler.ProvideHandlers(agentRuntimeHandler, agentProvisioningHandler, authHandler, userHandler, apiKeyHandler, usageHandler, redeemHandler, subscriptionHandler, announcementHandler, channelMonitorUserHandler, channelMonitorV2Handler, adminHandlers, gatewayHandler, openAIGatewayHandler, handlerSettingHandler, totpHandler, passkeyHandler, handlerPaymentHandler, paymentWebhookHandler, availableChannelHandler, modelPlazaHandler, asyncImageHandler, batchImageHandler, idempotencyCoordinator, idempotencyCleanupService, openAIQuotaAutoResetService)
	jwtAuthMiddleware := middleware.NewJWTAuthMiddleware(authService, userService, settingService, auditLogService)
	optionalJWTAuthMiddleware := middleware.NewOptionalJWTAuthMiddleware(authService, userService, settingService, auditLogService)
	adminAuthMiddleware := middleware.NewAdminAuthMiddleware(authService, userService, settingService, auditLogService)
	apiKeyAuthMiddleware := middleware.ProvideAPIKeyAuthMiddleware(apiKeyService, subscriptionService, configConfig, agentProvisioningService)
