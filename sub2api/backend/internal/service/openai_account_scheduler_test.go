...
func TestOpenAIGatewayService_SelectAccountWithScheduler_SessionStickyBusyEscapesToLoadBalance(t *testing.T) {
	ctx := context.Background()
	groupID := int64(10100)
	accounts := []Account{
		{
	...
	require.NotNil(t, selection)
	require.NotNil(t, selection.Account)
	require.Equal(t, int64(21002), selection.Account.ID, "busy sticky account should escape to another channel")
...
func TestOpenAIGatewayService_SelectAccountWithScheduler_SessionStickyBusyStillEscapesWhenStickyEscapeDisabled(t *testing.T) {
	ctx := context.Background()
	groupID := int64(10104)
	accounts := []Account{
