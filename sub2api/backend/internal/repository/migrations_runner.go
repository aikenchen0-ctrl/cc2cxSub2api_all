...
var migrationChecksumCompatibilityRules = map[string]migrationChecksumCompatibilityRule{
	...
	// 240 repairs constraints that were already created by an earlier local build.
	// Both hashes are retained because the migration is idempotent and historical
	// development images embedded either byte-identical version.
	"240_repair_sso_secret_constraints.sql": newMigrationChecksumCompatibilityRule("1ca9a3700d6883999f0a11c103b5baf11b17e48e252bf1bea7f768a9551e0146", "cfb2b804682b0bf02a6eabcb0ea713c811bfb9e17bf55bc54df080a41bf881ff"),
}
