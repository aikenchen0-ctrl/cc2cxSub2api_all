...
func RegisterAuthRoutes(
	...
	{
		auth.GET("/integrations/:slug/start", rateLimiter.LimitWithOptions("sso-start", 20, time.Minute, middleware.RateLimitOptions{
			FailureMode: middleware.RateLimitFailClose,
		}), gin.HandlerFunc(jwtAuth), h.Auth.IntegrationSSOStart)
