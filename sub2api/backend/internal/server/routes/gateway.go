...
func getGroupPlatform(c *gin.Context) string {
	...
	// Super keys are intentionally cross-group; expose the OpenAI-compatible
	// gateway route regardless of any stale group reference so media endpoints
	// are not rejected before cross-group scheduling.
	if apiKey.IsSuper() {
