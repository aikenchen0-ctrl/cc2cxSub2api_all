...
func RegisterGatewayRoutes(
	...
	imagesHandler := func(c *gin.Context) {
		if service.IsGrokImageGenerationModel(peekGatewayRequestModel(c)) {
	...
	videoGenerationHandler := func(c *gin.Context) {
		...
		if apiKey, ok := middleware.GetAPIKeyFromContext(c); ok && apiKey.IsSuper() {
...
func getGroupPlatform(c *gin.Context) string {
	...
	if apiKey.IsSuper() && apiKey.Group == nil {
...
func peekGatewayRequestModel(c *gin.Context) string {
