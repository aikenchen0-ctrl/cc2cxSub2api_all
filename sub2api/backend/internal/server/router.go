...
func registerRoutes(
	...
	routes.RegisterAgentProvisioningRoutes(v1, h.AgentProvisioning, adminAuth, auditLog, settingService, panelRateLimiter)
	routes.RegisterAgentRuntimeRoutes(v1, h.AgentRuntime, h.AgentProvisioning.RuntimeAuthMiddleware(), gin.HandlerFunc(optionalJWTAuth))
