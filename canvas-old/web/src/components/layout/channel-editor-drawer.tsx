            ...
            <div className="grid gap-4 md:grid-cols-2">
                ...
                <label className="block md:col-span-2">
                    ...
                    <Space.Compact className="w-full">
                        <Input value={draft.baseUrl} onChange={(event) => patch({ baseUrl: event.target.value })} placeholder="http://localhost:18080" />
                        <Button onClick={() => patch({ baseUrl: "http://localhost:18080", apiFormat: "openai" })}>本地网关</Button>
                    </Space.Compact>
                </label>
                <label className="block md:col-span-2">
