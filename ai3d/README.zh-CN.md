...
AI 驱动的交互式 3D 生成、检查和演示工作台。

cc2cx AI3D生成 是一个 React + Three.js 应用，用于把上传图片、草图或 GLB 文件变成可交互的 3D 工作区。它支持混元图片生成 3D、混元草图加提示词生成、WebGL 旋转缩放、截图、GLB 导出、任务恢复和演示模式。

## 演示视频

[![cc2cx AI3D生成演示视频](docs/demo/3DCellForge-demo-cover.jpg)](docs/demo/3DCellForge-demo-2026-05-10.mp4)
