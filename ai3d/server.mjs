...
import { API_HOST, API_PORT, FAL_API_KEY, HUNYUAN_API_BASE, HUNYUAN_CLOUD_API_KEY, RODIN_API_KEY, TRIPO_API_KEY } from './server/config.mjs'
...
server.listen(API_PORT, API_HOST, () => {
  ...
  console.log(HUNYUAN_CLOUD_API_KEY ? 'Hunyuan cloud API key loaded from environment.' : `Hunyuan3D local provider: ${HUNYUAN_API_BASE}`)
  logEvent('info', 'api.start', {
    ...
    providers: {
      ...
      hunyuan: Boolean(HUNYUAN_CLOUD_API_KEY || HUNYUAN_API_BASE),
      hunyuanCloud: Boolean(HUNYUAN_CLOUD_API_KEY),
