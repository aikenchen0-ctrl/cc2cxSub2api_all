...
export const GENERATION_MODE_OPTIONS = [
  { id: 'hunyuan', label: 'Hunyuan', description: 'Tencent Hunyuan 3.1 image-to-3D generation.' },
  { id: HUNYUAN_SKETCH_MODE, label: 'Hunyuan Sketch', description: 'Tencent Hunyuan 3.0 sketch plus Chinese prompt.' },
