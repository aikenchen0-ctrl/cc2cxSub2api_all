...
AI-powered interactive 3D generation, inspection, and presentation workspace.

cc2cx AI3D生成 is a React + Three.js application for turning uploaded reference images, sketches, or GLB files into a polished interactive 3D workspace. It supports Hunyuan image-to-3D and sketch-plus-prompt generation, live WebGL controls, screenshots, GLB export, task recovery, and presentation mode.

## Demo

[![cc2cx AI3D生成 demo](docs/demo/3DCellForge-demo-cover.jpg)](docs/demo/3DCellForge-demo-2026-05-10.mp4)
