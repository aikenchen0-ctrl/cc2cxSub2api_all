...
export function NewHuntPage() {
  ...
  const [targetLeadCount, setTargetLeadCount] = useState(20);
  ...
  const searchReadiness = settingsQuery.data?.search_readiness;
  ...
  return (
    <div className="max-w-2xl mx-auto">
      ...
      {searchWarning && (
        <div className="mb-6 rounded-md border border-amber-300 bg-amber-50 px-4 py-3 text-sm text-amber-900 dark:border-amber-700 dark:bg-amber-950/40 dark:text-amber-100">
          {searchWarning}
        </div>
      )}
        ...
        <Card>
          ...
          <CardContent className="space-y-3">
            <div className="flex gap-2">
              <Input
                placeholder={t("newHunt.keywordPlaceholder")}
                value={keywordInput}
          ...
          <CardContent className="grid grid-cols-1 gap-4 md:grid-cols-3">
            ...
            <div className="space-y-2">
              ...
              <p className="text-xs text-muted-foreground">
                若某轮新增少于这个值会停。公开网页被墙且本轮 0 新增也会立刻停。
              </p>
            </div>
          </CardContent>
        </Card>
            ...
            <div className="rounded-lg border border-dashed p-4">
              ...
              {enableEmailCraft && (
                <div className="mt-4 space-y-4">
                  ...
                  <div className="space-y-2">
                    <label className="text-sm font-medium">{t("newHunt.notes")} <span className="text-muted-foreground font-normal">{t("common.optional")}</span></label>
                    <textarea
