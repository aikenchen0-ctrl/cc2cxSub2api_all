...
class CompanyWebsiteFinder:
    ...
    def __init__(self, search_tool: WebSearcher | None = None) -> None:
        self._search_tool = search_tool
        self._owns_search_tool = search_tool is None

    async def _get_search_tool(self) -> WebSearcher:
        if self._search_tool is None:
            self._search_tool = open_web_search(allow_encyclopedia=False)
