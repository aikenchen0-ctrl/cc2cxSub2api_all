...
export const agentAPI = {
  ...
  getUsers: async () => (await agentClient.get<{ items: AgentUserView[]; total: number }>('/agent/users')).data,
  getUsage: async () => (await agentClient.get<{ items: AgentUsageView[]; total: number }>('/agent/usage')).data,
  recharge: {
