...
func configuredSub2APIModels() ([]sub2APIRelayModel, error) {
	...
	groups := []struct {
		...
		{"SUB2API_RELAY_IMAGE_MODELS", "image", model.ChannelInterfaceOpenAIImage, splitCSV(os.Getenv("SUB2API_RELAY_IMAGE_MODELS"))},
		{"SUB2API_RELAY_VIDEO_MODELS", "video", model.ChannelInterfaceType("sub2api-video-v1"), splitCSV(os.Getenv("SUB2API_RELAY_VIDEO_MODELS"))},
	}
