...
var schemaMigrations = []migration{
	...
	{version: 11, name: "sub2api_sso", checksum: "sha256:sub2api-sso-v11-20260918", apply: migrateSub2APISSO},
}

func migrateSub2APISSO(tx *gorm.DB) error {
	return tx.AutoMigrate(&model.SSOTicket{}, &model.SSOHandoff{}, &model.SSORevocation{}, &model.AuthSession{})
}
