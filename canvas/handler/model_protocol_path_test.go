...
func TestModelProtocolProxyPathContract(t *testing.T) {
	tests := []struct {
		...
		{"Amam A-SD2.0 standard endpoint", "openai", "", "A-SD2.0", "/videos", "/videos"},
		{"Amam A-SD2.0 poll endpoint", "openai", "", "A-SD2.0", "/videos/task", "/videos/task"},
		{"Amam model does not hijack KIE", "kie", "", "A-SD2.0", "/videos", "/jobs/createTask"},
