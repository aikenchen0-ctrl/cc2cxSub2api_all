...
class SessionAuthMiddleware(BaseHTTPMiddleware):
    ...
    async def dispatch(self, request: Request, call_next):
        ...
        async with async_session_maker() as session:
            ...
            subject = await load_subject_for_user(session, principal.user_id)
            subject_token = set_current_sub2api_subject(subject)
            try:
                ...
                reset_current_sub2api_subject(subject_token)
