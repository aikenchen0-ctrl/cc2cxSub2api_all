      ...
      notify.error("模板不可用", "请先初始化模板再重试。 ");
        ...
        void (async () => {
            ...
            try {
                ...
                notify.error(`第 ${slideIndex + 1} 页失败`, errorMessage);
            }
        })();
    }, [
        createAndSaveTemplateV2Layouts,
