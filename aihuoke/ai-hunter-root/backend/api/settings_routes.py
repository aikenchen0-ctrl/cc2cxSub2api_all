...
class SettingsPayload(BaseModel):
    ...
    osint_enrichment_enabled: str = ""
    builtwith_api_key: str = ""
    social_presence_enabled: str = ""
    social_presence_use_maigret: str = ""
    social_presence_max_sites: str = ""
    social_presence_country_tags: str = ""
    licensed_finder_enabled: str = ""
    bettercontact_api_key: str = ""
    licensed_finder_timeout_seconds: str = ""
    site_scan_enabled: str = ""
    firecrawl_api_key: str = ""
    site_scan_max_pages: str = ""
    email_provider_type: str = ""
    email_dry_run: str = ""
    email_block_freemail: str = ""
    email_min_minutes_between_sends: str = ""
    email_verify_min_fit_score: str = ""
    amap_api_key: str = ""
    baidu_api_key: str = ""
    hunter_api_key: str = ""
    email_from_name: str = ""
...
async def save_settings(payload: SettingsPayload):
    ...
    field_map = {
        ...
        "email_verify_min_fit_score": "EMAIL_VERIFY_MIN_FIT_SCORE",
